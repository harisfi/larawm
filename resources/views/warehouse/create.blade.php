        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <form action="{{ route('warehouse.store') }}" method="POST" class="m-3">
                        @csrf
                        <div class="form-group required">
                            <label for="name" class="form-control-label">Name</label>
                            <input name="name" id="name" class="form-control" type="text" placeholder="PT Company" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="form-group required">
                            ...
                            <input name="branch" id="branch" class="form-control" type="text" placeholder="New York" value="{{ old('branch') }}" required>
                            @error('branch')
                                <p class="text-sm text-danger ms-1">{{ $message }}</p>
                            @enderror
                        </div>
